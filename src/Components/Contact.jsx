    ...
    return (
        <Element name='contact' >
            <Flex  direction={['column','row','row']} id='contact'  justifyContent='center' alignContent='center'>
                <Box  boxShadow ='rgb(127,127,127) 0px 5px 15px' mx={['40px','25px','50px']} p={['10px','15px','25px']} borderRadius='8px' justifyContent='center'>
                    ...
                    <Box p={5}>
                        ...
                        <Input name='name' value={name} onChange={(e)=>setName(e.target.value)} w={["225px","225px","250px"]} />
                    </Box>
                    <Box p={5}>
                        <Text marginBottom={2}>Email</Text>
                        <Input name='email' value={email} onChange={(e)=>setEmail(e.target.value)} w={["225px","225px","250px"]} />
                    </Box>
                    <Box p={5}>
                        <Text marginBottom={2}>Message</Text>
                        <Input name='message' value={message} onChange={(e)=>setMessage(e.target.value)} w={["225px","225px","250px"]} />
                    </Box>
