...
const Github = () => {
    return (
        <Box id='projects' boxShadow ='rgb(127,127,127) 0px 5px 15px' mx={['15px','25px','50px']} my='150px' p={['10px','15px','25px']} borderRadius='8px'>
            ...
            <Box margin='auto' marginTop='30px' w={['250px','350px','600px','800px']} >
                <Text textAlign='center' fontSize='25px' color='white' >Github Streaks</Text>
                <Image marginTop='10px' w={['250px','350px','600px','800px']} src="https://github-readme-streak-stats.herokuapp.com/?user=syed25794&" alt="syed25794" />
            </Box>
